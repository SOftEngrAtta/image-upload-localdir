...
module.exports = (connection)=>{
    ...
    router.post('/image' , (req , res)=>{
        ...
        form.parse(req,(error,fields,files)=>{
            ...
            var imageBase64 = fields['ImageStrg'][0];
            ...
            fsPath.writeFile('C:/Users/atta/Desktop/clients/node-server/images'+files['file'][0]['originalFilename'], imageBuffer.data,  function(err){
                if (err) throw err
